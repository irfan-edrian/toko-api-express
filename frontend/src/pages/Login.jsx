  ...
  return (
    <div className="max-w-md mx-auto mt-16 p-8 bg-slate-800/80 backdrop-blur-xl rounded-2xl shadow-2xl border border-slate-700/50 relative overflow-hidden">
      ...
      <div className="relative z-10">
        <h2 className="text-3xl font-extrabold mb-2 text-center bg-gradient-to-r from-blue-400 to-indigo-400 bg-clip-text text-transparent">Halooo semua</h2>
        <p className="text-slate-400 text-center mb-8 text-sm">log in untuk masuk ke yahhh</p>
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          ...
          >
            {isLoading ? 'Authenticating...' : 'sini tekann'}
          </button>
        </form>
      </div>
    </div>
